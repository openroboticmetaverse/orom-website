<template>
    <div>
      ...
      <template v-slot:description>
                ...
                <div class="py-10"></div>
                <a  href="mailto:openroboticmetaverse@gmail.com" class="email-link gradient-text-right hover:text-teal-200 duration-500 ease-in-out">openroboticmetaverse@gmail.com</a> 
            </template>
