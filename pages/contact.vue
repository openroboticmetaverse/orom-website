<template>
    <div>
      ...
      <template v-slot:description>
                <p class="mt-6 text-2xl sm:text-6xl leading-8 ml-200 max-w-2xl text-left text-gray-300">Ready to Make a Difference? Reach out to us and start your journey today!</p>
                <div class="py-10"></div>
