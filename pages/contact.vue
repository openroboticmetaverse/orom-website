<template>
    <div>
      ...
      <template v-slot:email>
        <a  href="mailto:openroboticmetaverse@gmail.com" class="email-link max-w-xl mt-4 text-xl sm:text-2xl lg:text-4xl px-10 sm:px-0 tracking-tight gradient-text-right hover:text-teal-200 duration-500 ease-in-out">openroboticmetaverse@gmail.com</a>
            </template>
      ...
      <template v-slot:icons>
        <div class="relative mt-10 flex justify-center items-center">
            ...
            <a href="https://instagram.com/openroboticmetaverse" class="text-gray-300 hover:text-gray-100 duration-500 ease-in-out">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-6" fill="currentColor"  viewBox="0 0 24 24">
              <path
            ...
            <a href="https://github.com/openroboverse" class="text-gray-300 hover:text-gray-100 duration-500 ease-in-out">
