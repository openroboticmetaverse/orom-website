<template>
    <div class="container mx-auto px-12">
        <header class="text-center py-4">
            <h1 class="text-4xl font-bold gradient-text-right">Datenschutzerklärung</h1>
        </header>

        <section class="py-4">
            <h3 class="text-2xl font-semibold text-white">Allgemeiner Hinweis und Pflichtinformationen</h3>
            <h3 class="text-xl font-semibold text-white">Benennung der verantwortlichen Stelle</h3>
            <p class="mt-2 text-lg">Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</p>
            <address class="mt-2 text-lg">
                open robotic metaverse e.V.<br>
                Jülicher Str. 209d<br>
                52070 Aachen<br>
                Germany
            </address>
            <p class="mt-2 text-lg">Die verantwortliche Stelle entscheidet allein oder gemeinsam mit anderen über die Zwecke
                und Mittel der Verarbeitung von personenbezogenen Daten (z.B. Namen, Kontaktdaten ..)</p>
            <br>
            <h3 class="text-xl font-semibold text-white">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
            <p>Nur mit Ihrer ausdrücklichen Einwilligung sind einige Vorgänge der Datenverarbeitung möglich. Ein Widerruf
                ...
                unberührt.</p>
            <br>
            <h3 class="text-xl font-semibold text-white">Recht auf Beschwerde bei der zuständigen Aufsichtsbehörde</h3>
            ...
            <br>
            <h3 class="text-xl font-semibold text-white">Recht auf Datenübertragbarkeit</h3>
            <p class="mt-2 text-lg">Ihnen steht das Recht zu, Daten, die wir auf Grundlage Ihrer Einwilligung oder in
                Erfüllung eines Vertrags automatisiert verarbeiten, an sich oder an Dritte aushändigen zu lassen. Die
                Bereitstellung erfolgt in einem maschinenlesbaren Format. Sofern Sie die direkte Übertragung der Daten an
                einen anderen Verantwortlichen verlangen, erfolgt dies nur, soweit es technisch machbar ist.</p>
            <br>
            <h3 class="text-xl font-semibold text-white">Recht auf Auskunft, Berichtigung, Sperrung, Löschung</h3>
            ...
            <br>
            <h3 class="text-xl font-semibold text-white">SSL- bzw. TLS-Verschlüsselung</h3>
            <p class="mt-2 text-lg">Aus Sicherheitsgründen und zum Schutz der Übertragung vertraulicher Inhalte, die Sie an
                uns als Seitenbetreiber senden, nutzt unsere Website eine SSL-bzw. TLS-Verschlüsselung. Damit sind Daten,
            ...
            <p class="mt-2 text-lg">Per Kontaktformular übermittelte Daten werden einschließlich Ihrer Kontaktdaten
                gespeichert, um Ihre Anfrage bearbeiten zu können oder um für Anschlussfragen bereitzustehen. Eine
                Weitergabe dieser Daten findet ohne Ihre Einwilligung nicht statt.</p>

            <p class="mt-2 text-lg">Die Verarbeitung der in das Kontaktformular eingegebenen Daten erfolgt ausschließlich
                auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Ein Widerruf Ihrer bereits erteilten
                Einwilligung ist jederzeit möglich. Für den Widerruf genügt eine formlose Mitteilung per E-Mail. Die
                Rechtmäßigkeit der bis zum Widerruf erfolgten Datenverarbeitungsvorgänge bleibt vom Widerruf unberührt.</p>

            <p class="mt-2 text-lg">Über das Kontaktformular übermittelte Daten verbleiben bei uns, bis Sie uns zur Löschung
                auffordern, Ihre Einwilligung zur Speicherung widerrufen oder keine Notwendigkeit der Datenspeicherung mehr
