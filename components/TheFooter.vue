                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div class="mb-6 md:mb-0">
                        <a href="https://openroboticmetaverse.org/" class="flex items-center">
                            <img src="/icon.svg" class="h-10 mr-3" alt="orom Logo" />
                        </a>
                    </div>
                    ...
                    <div class="flex justify-between">
                            <div>
                                <a href="privacy" class="text-gray-300 dark:text-gray-400 font-medium hover:underline mr-6">Privacy Policy</a>
                            </div>
                            <div>
                                <a href="imprint" class="text-gray-300 dark:text-gray-400 font-medium hover:underline">Imprint</a>
                            </div>
                        </div>
                </div>
                    ...
                    <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        ...
                        <a href="#" class="text-gray-300 hover:text-white">
                            <Icon name="bi:instagram" color="currentColor" class="w-4 h-4" aria-hidden="true" viewBox="0 0 8 19"/>
