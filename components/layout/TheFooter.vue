            ...
            <div class="mx-auto w-full max-w-screen-7xl p-9 py-6 lg:py-8">
                <div class="flex justify-between">
                    <div class="mb-6 md:mb-0">
                        <a href="https://flowbite.com/" class="flex items-center">
                            ...
                            <span class="self-center lg:text-2xl text-sm font-semibold whitespace-nowrap dark:text-white lg:block hidden">Open Robotic Metaverse</span>
                        </a>
                    </div>
                    <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 ml-3">
                        ...
                        <div>
                            ...
                            <ul class="text-gray-300 dark:text-gray-400 font-medium">
                                <li class="mb-4">
                                    <a href="https://github.com/openroboverse" class="hover:underline ">Github</a>
                                </li>
                                <li>
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-300 sm:text-center dark:text-gray-400">© 2023 <a
                            href="https://flowbite.com/" class="hover:underline">Open Robotic Metaverse e.V.</a>. All Rights Reserved.
                    </span>
